...
namespace Benchmark701 {
  ...
  real_t      a0     = -25600.0;  // left inner endpoint
  real_t      b0     = +25600.0;  // right inner endpoint
...
int main(int argc, char * argv[]) {
  ...
  std::size_t n = 10 * multiplicador_de_dominio * refino_da_malha + 1;
  ...
  if (tipo_coefficientes == "spec") {
    ...
    > method(ealpha, a, b, n);
    tempo_2 = std::chrono::high_resolution_clock::now();
    method.compute_truncated(fnyvals, ja, jb, FLY0);
    tempo_3 = std::chrono::high_resolution_clock::now();
  } else if (tipo_coefficientes == "huob2") {
    frlap::generalized_differences<
            real_t,
    ...
    frlap::generalized_differences<
            real_t,
            coefficients::centered_3_point_periodized
            > method(ealpha, a, b, n);
    tempo_2 = std::chrono::high_resolution_clock::now();
    method.compute_truncated(fnyvals, ja, jb, FLY0);
    tempo_3 = std::chrono::high_resolution_clock::now();
