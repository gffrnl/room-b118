...
target_sources(b118-basic
    PUBLIC
        FILE_SET b118_basic_public_headers
            TYPE HEADERS
            FILES
                ${B188_INCLUDE_DIR}/b118/type_traits.hpp
                ${B188_INCLUDE_DIR}/b118/numbers.hpp
                ${B188_INCLUDE_DIR}/b118/almost_equal.hpp
                ${B188_INCLUDE_DIR}/b118/equal_within_ulps.hpp
                ${B188_INCLUDE_DIR}/b118/linspace.hpp
                # vendors
                ${B188_INCLUDE_DIR}/b118/vendor/cppreference/equal_within_ulps.hpp
)

target_sources(b118-basic PRIVATE ${CMAKE_PROJECT_}src/file.cpp)
