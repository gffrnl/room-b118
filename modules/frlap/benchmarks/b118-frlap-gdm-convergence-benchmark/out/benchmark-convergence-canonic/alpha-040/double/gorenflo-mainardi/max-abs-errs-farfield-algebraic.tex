...
% Coefficients from gorenflo_mainardi method
...
% Theoretical error y = 0.04*h
\addplot [domain=8e-4:0.8, samples=101, color=gray, line width=6pt, dashed] {0.04*x};
\addlegendentry{$O(h)$};
