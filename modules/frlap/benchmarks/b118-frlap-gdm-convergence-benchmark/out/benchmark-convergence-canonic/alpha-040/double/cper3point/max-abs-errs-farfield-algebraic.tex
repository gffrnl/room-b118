...
% Coefficients from cper3point method
...
% Theoretical error y = 0.0134*h^(2)
\addplot [domain=8e-4:0.8, samples=101, color=gray, line width=6pt, dashed] {0.0134*x^(2)};
